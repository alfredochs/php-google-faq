...
$dataBase = [
    ...
    [
        ...
        "paragraphs" => "<p>Sappiamo che la sicurezza e la privacy sono importanti per te e lo sono anche per noi. Per noi è imperativo offrire un'elevata sicurezza e assicurarti che le tue informazioni sono al sicuro e accessibili quando ne hai bisogno.</p>
...
<body>
    ...
    <main class="container w-75">
        ...
        foreach ($dataBase as $key => $valore) {
            ...
            $paragrafi = $valore["paragraphs"];
            echo "<h3 class=''>$titolo</h3><br>
            <p class ='titolo'>$paragrafi</p>";
        }
        ?>
        ...
        <!-- <div class="container w-75">
            ...
            //     echo "<h3 class='titolo'>$chiavi</h3>";
            //     foreach ($valore as $paragrafi) {
            //         foreach ($paragrafi as $testo) {
            //             echo "<p class='paragrafo'>$testo</p>";
            //             foreach ($testo as $punti => $testoPunti) {;
            //             }
            //         }
            //     }
            // };
